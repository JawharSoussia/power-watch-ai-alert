...
const locations: Location[] = [
  { id: 1, lat: 40.7128, lng: -74.0060, status: 'normal', name: 'New York Grid' },
  ...
  { id: 5, lat: 33.4484, lng: -112.0740, status: 'normal', name: 'Phoenix Grid' },
...
const Map: React.FC = () => {
  useEffect(() => {
    // Fix for the Leaflet icon loading issue
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border border-border">
          ...
          <div className="flex justify-center space-x-6 mt-6">
            <div className="flex items-center">
              <span className="h-3 w-3 rounded-full bg-electric-500 inline-block mr-2"></span>
            ...
            <div className="flex items-center">
              <span className="h-3 w-3 rounded-full bg-alert-500 inline-block mr-2"></span>
