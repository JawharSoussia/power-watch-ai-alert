    ...
    >
      <div className="container mx-auto flex justify-between items-center px-4 md:px-6">
        <div className="flex items-center">
          ...
          <span className="text-xl font-bold text-foreground">PowerWatch<span className="text-electric-500">AI</span></span>
        </div>
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a href="#testimonials" className="text-foreground/90 hover:text-electric-600 transition-colors">Case Studies</a>
        </nav>
        
        <div className="flex items-center space-x-4">
          <Button variant="ghost" className="hidden md:flex">Log In</Button>
          <Button className="bg-gradient-to-r from-electric-600 to-energy-500 hover:from-electric-700 hover:to-energy-600 text-white">
            Request Demo
          </Button>
        </div>
      </div>
